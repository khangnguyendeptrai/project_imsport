    ...
    return (
        <div className='absolute top-1/2 left-[-5px] translate-y-[-50%] opacity-0 z-10 group-hover:opacity-100 transition-all duration-500 flex flex-col gap-y-1'>
            <div className='w-11 h-11 relative group/icon bg-white hover:bg-[#673AB7] rounded flex items-center justify-center'>
                ...
                <span className=" z-50 absolute left-1/2 bottom-[-40px] ml-2 -translate-y-1/2 px-2 py-1 text-sm bg-black text-white rounded opacity-0 group-hover/icon:opacity-100 transition-opacity duration-100 whitespace-nowrap ">
                    Xem nhanh
                </span>
            </div>
            <div className='w-11 h-11 relative group/icon bg-white hover:bg-[#673AB7] rounded flex items-center justify-center'>
