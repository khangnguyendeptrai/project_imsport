...
// Loại bỏ các thư viện bên ngoài (Swiper, swiper/css/navigation) và các asset import bị lỗi.
import { EyeIcon, MagnifyingGlassPlusIcon } from "@heroicons/react/24/outline";

// --- KHẮC PHỤC LỖI RESOLVE ASSETS: Sử dụng URL placeholder cho hình ảnh ---
// Đây là cách an toàn nhất để đảm bảo code chạy được trong môi trường single-file
const IMAGE_PLACEHOLDER = 'https://placehold.co/400x440/f3f4f6/333?text=Product';
const IMAGE_HIDE_PLACEHOLDER = 'https://placehold.co/400x440/e5e7eb/333?text=Hover+View';

// Giả định các biến hình ảnh bây giờ là placeholder để tránh lỗi import
const buckethat = IMAGE_PLACEHOLDER;
const buckethathide = IMAGE_HIDE_PLACEHOLDER;
const giaykje = IMAGE_PLACEHOLDER;
const giaykjehide = IMAGE_HIDE_PLACEHOLDER;
const giayhoka = IMAGE_PLACEHOLDER;
const giayhokahide = IMAGE_HIDE_PLACEHOLDER;
const thunnam = IMAGE_PLACEHOLDER;
const thunnamhide = IMAGE_HIDE_PLACEHOLDER;
const giaycloudbom = IMAGE_PLACEHOLDER;
const giaycloudbomhide = IMAGE_HIDE_PLACEHOLDER;
const giaymafe = IMAGE_PLACEHOLDER;
const giaymafehide = IMAGE_HIDE_PLACEHOLDER;
const giaynam = IMAGE_PLACEHOLDER;
const giaynamhide = IMAGE_HIDE_PLACEHOLDER;
const khoacnu = IMAGE_PLACEHOLDER;
const khoacnuhide = IMAGE_HIDE_PLACEHOLDER;
const khoacrun = IMAGE_PLACEHOLDER;
const khoacrunhide = IMAGE_HIDE_PLACEHOLDER;
const aotrail = IMAGE_PLACEHOLDER;
const aotrailhide = IMAGE_HIDE_PLACEHOLDER;
...
// Component đơn giản để hiển thị badge giảm giá
const DiscountBadge = () => (
...
const ProductsSection = () => {
  return (
    <>
      {/* 1. Sản phẩm mới: centerItems=false (mặc định), đổ từ trái sang */}
      <ProductSlider title="Sản phẩm mới" items={newProducts} />
      
      {/* 2. Sản phẩm sale off: centerItems=true, bắt buộc căn giữa */}
