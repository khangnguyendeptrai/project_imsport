...
const ProductInfo = ({ name, brand, code, price, sizes, highlights }) => {
  ...
  return (
    ...
    <div className="pb-6 border-gray-200 mb-6 flex items-center gap-4 flex-wrap md:flex-nowrap">
  <div className="flex-1 min-w-0">
    ...
    <input
      ...
      className="w-full h-10 border border-gray-300 rounded-full text-center"
    />
  </div>

  <button className="bg-[#673AB7] text-white px-8 py-3 rounded-full uppercase font-medium hover:bg-[#7e4fd1] transition-all whitespace-nowrap">
    Thêm vào giỏ hàng
  </button>
