...
const ProductInfo = ({ name, brand, code, price, sizes, highlights }) => {
  ...
  return (
    <div >
      <h1 className="text-2xl font-semibold mb-2 break-words whitespace-normal w-full">
        {name}
      </h1>
        ...
        <div className="flex flex-wrap gap-2">
          {sizes.map((size) => (
            <button
              ...
              className={`w-12 h-10 border rounded-md text-sm font-medium ${selectedSize === size
