...
const ProductInfo = ({ name, brand, code, price, sizes, highlights }) => {
  ...
  return (
    <div className="w-full md:w-[90%] text-gray-800 md:static md:pb-0 pb-24">
      ...
      <div className="md:static  w-full bg-white border-t border-gray-200 flex items-center justify-between px-4 py-3 md:py-0 md:px-0 md:border-0 md:bg-transparent">
