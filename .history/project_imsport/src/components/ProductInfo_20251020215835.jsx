    ...
    <div className="w-full md:w-[90%] text-gray-800 md:static md:pb-0 pb-24">
      ...
      <div className="pb-6 border-gray-200 mb-6">
        ...
        <input
          ...
          className="w-full md:w-20 h-10 border border-gray-300 rounded-full text-center"
        />
      </div>

      {/* Nút giỏ hàng + yêu thích (PC giữ nguyên, mobile fixed bottom) */}
      <div className="md:static fixed bottom-0 left-0 w-full bg-white border-t border-gray-200 flex items-center justify-between px-4 py-3 md:py-0 md:px-0 md:border-0 md:bg-transparent">
        <button className="bg-[#673AB7] text-white flex-1 md:flex-none md:w-auto px-8 py-3 rounded-full uppercase font-medium hover:bg-[#7e4fd1] transition-all mr-4">
          Thêm vào giỏ hàng
        </button>
