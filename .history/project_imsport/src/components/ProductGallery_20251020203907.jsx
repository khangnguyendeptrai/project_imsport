      ...
      <div className="md:hidden w-full mt-4">
        <div className="flex items-center justify-between px-2">
          <button
            ...
            className={`p-2 rounded-full  ${mobileStart === 0 ? "opacity-100 hover:bg-gray-100" : "opacity-100 hover:bg-gray-100"}`}
          ...
          <button
            ...
            className={`p-2 rounded-full  ${mobileStart + mobileVisible >= images.length ? "opacity-40" : "opacity-100 hover:bg-gray-100"}`}
