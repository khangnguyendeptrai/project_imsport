...
const ProductInfo = ({ name, brand, code, price, sizes, highlights }) => {
  ...
  return (
    <div className="w-full md:w-[90%] text-gray-800">
      ...
      <p className="text-sm text-gray-600 mb-4 border-b border-gray-200 mb-6 pb-5">
        Thương hiệu:{" "}
      ...
      {/* Giá */}
      <p className="text-2xl font-semibold text-black pb-4 ">
        Giá: <span className="text-[#898989]">{price}</span>
      </p>
