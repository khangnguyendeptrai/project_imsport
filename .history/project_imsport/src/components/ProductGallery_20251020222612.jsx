...
<div className="md:hidden relative w-full mt-4">
  ...
  <div className="overflow-hidden w-full relative">
    ...
    <button
      ...
      className={`absolute top-1/2 -translate-y-1/2 bg-black/50 text-white p-2 rounded-full z-10 transition-opacity duration-200 ${
        mobileStart === 0
          ? "opacity-40 cursor-not-allowed"
          : "opacity-100"
      }`}
      style={{
        left: `calc(((100% - 3 * 0.5rem) / 4) * 0 - 1.5rem)`, // lệch ra ngoài chút
      }}
    >
    ...
    <button
      ...
      style={{
        right: `calc(((100% - 3 * 0.5rem) / 4) * 0 - 1.5rem)`,
      }}
    >
