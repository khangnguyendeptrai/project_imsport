...
const ProductGallery = ({ images }) => {
  ...
  const lensSize = 150; // kích thước khung zoom
  ...
  return (
    <div className="flex flex-col md:flex-row gap-4">
      ...
      <div className="relative flex-1 flex justify-center items-center">
        ...
        {showZoom && (
          <div
            className="absolute border border-gray-500 bg-gray-300/15 pointer-events-none hidden md:block"
            style={{
              width: `${lensSize}px`,
              height: `${lensSize}px`,
        ...
        {showZoom && (
          <div
            className="hidden md:block absolute lg:right-[-420px] md:right-[-300px] top-0 w-[300px] md:w-[350px] lg:w-[400px] h-[300px] md:h-[380px] lg:h-[420px] border-2 border-gray-600 bg-white overflow-hidden z-10 rounded-lg shadow-lg"
            style={{
