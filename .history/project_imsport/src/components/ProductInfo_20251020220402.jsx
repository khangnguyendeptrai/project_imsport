...
const ProductInfo = ({ name, brand, code, price, sizes, highlights }) => {
  ...
  return (
    <div className="w-full md:w-[90%] text-gray-800 md:static md:pb-0 pb-24">
      {/* Tên sản phẩm */}
...
{/* Số lượng */}
<div className="pb-6 border-gray-200 mb-6">
  ...
  <input
    ...
    className="w-full md:w-36 h-10 border border-gray-300 rounded-full text-center"
  />
</div>
...
<div
  className="
    fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200 flex items-center justify-between px-4 py-3
    md:static md:border-0 md:bg-transparent md:px-0 md:py-0 md:flex md:items-center md:gap-4
  "
>
  <button className="bg-[#673AB7] text-white flex-1 md:flex-none md:w-auto px-8 py-3 rounded-full uppercase font-medium hover:bg-[#7e4fd1] transition-all">
    Thêm vào giỏ hàng
  </button>

  <button className="w-10 h-10 border border-gray-300 rounded-full flex items-center justify-center transition-all hover:border-[#673AB7] hover:text-[#673AB7]">
