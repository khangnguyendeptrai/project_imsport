  ...
  return (
    <div className="flex flex-col md:flex-row gap-4">
      ...
      <div className="relative flex-1 flex justify-center items-center">
        ...
        {showZoom && (
          <div
            className="absolute border border-black/60 bg-yellow/10 pointer-events-none"
            style={{
              width: `${lensSize}px`,
              height: `${lensSize}px`,
        ...
        {showZoom && (
          <div
            className="hidden md:block absolute right-[-70%] top-20 w-[300px] h-[350px] border-2 border-gray-500 bg-white overflow-hidden z-10"
            style={{
