                    ...
                    >
                        {images.map((img, i) => (
                            <div
                                key={i}
                                onClick={() => setSelectedIndex(i)}
                                className="flex-shrink-0 flex items-center justify-center border border-gray-300 bg-white aspect-square"
                                style={{
                                    // tính toán auto-fit 4 ảnh + khoảng cách 2 * 3 (3 gap)
                                    width: `calc((100% - 3 * 0.5rem) / 4)`, // 0.5rem = 8px (gap-2)
                                }}
                            >
                                <img
                                    src={img}
